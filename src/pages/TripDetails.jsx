...
export default function TripDetails() {
  ...
  const [savedNotes, setSavedNotes] = useState(() => {
    try {
      const notes = JSON.parse(
        localStorage.getItem(`trip-notes-${id}`) || "null"
      );
  ...
  const [checklist, setChecklist] = useState(() => {
    try {
      return (
        JSON.parse(
          localStorage.getItem(`trip-checklist-${id}`) || "null"
        ) || {
          route: false,
          stay: false,
          essentials: false,
  ...
  const [customItems, setCustomItems] = useState(() => {
    try {
      return JSON.parse(
        localStorage.getItem(`trip-items-${id}`) || "[]"
      );
          ...
          async function(response) {
            ...
            try {
              ...
              alert(
                ...
                "but payment verification failed.\n\n" +
                "Error: " +
                (
                  verificationError?.message ||
                  "Unknown error"
          ...
          <div className="mt-8 flex justify-between">
            ...
            <div>
              ...
              <div className="mt-5 flex flex-wrap gap-3">
                ...
                <button
                  ...
                  className={`inline-flex items-center gap-2 rounded-2xl px-4 py-3 text-sm font-bold transition ${
                    saved
                      ...
                      : "bg-white text-slate-800 shadow-sm dark:bg-[#111827] dark:text-slate-200"
                  }`}
                >
                ...
                <button
                  type="button"
                  onClick={shareTrip}
                  className="inline-flex items-center gap-2 rounded-2xl border border-slate-300 px-4 py-3 text-sm font-bold text-slate-700 transition hover:border-blue-500 hover:text-blue-600 dark:border-slate-600 dark:text-slate-200"
                >
            ...
            <div className="bg-blue-600 text-white px-8 py-4 rounded-3xl flex flex-col items-center">
              ...
              <button
                ...
                className="mt-4 bg-green-500 hover:bg-green-600 disabled:bg-gray-400 px-6 py-3 rounded-2xl font-bold cursor-pointer disabled:cursor-not-allowed"
              >
          ...
          <section className="mt-10 rounded-3xl border border-slate-700 bg-[#111827] p-6 shadow-md">
            ...
            <div className="flex flex-wrap items-start justify-between gap-4">
              ...
              <div>
                ...
                <h2 className="mt-2 text-2xl font-black">
                  ...
                  Make this route real.

                </h2>

                <p className="mt-2 text-sm text-slate-400">

                  Three quick checks, saved automatically for this trip.
              ...
              <strong className="rounded-full bg-cyan-300/10 px-4 py-2 text-sm text-cyan-300">
                ...
                <button
                  ...
                  className={`flex items-center justify-between rounded-2xl border px-4 py-3 text-left text-sm font-bold transition ${
                    checklist[item.key]
                      ...
                      : "border-white/10 bg-white/5 text-slate-300 hover:border-cyan-300/50 hover:text-white"
                  }`}
                >
            ...
            >
              ...
              <input
                ...
                className="min-w-0 flex-1 rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-white outline-none placeholder:text-slate-500 focus:border-cyan-300/60"
              />


              <button
                type="submit"
                className="inline-flex items-center justify-center gap-2 rounded-2xl bg-cyan-300 px-5 py-3 text-sm font-bold text-slate-950 transition hover:bg-cyan-200"
              >
          ...
          <section className="mt-6 rounded-3xl border border-slate-200 bg-white p-6 shadow-md dark:border-slate-700 dark:bg-[#111827]">
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div>
                ...
                <p className="flex items-center gap-2 text-xs font-bold uppercase tracking-[0.2em] text-blue-600 dark:text-cyan-300">

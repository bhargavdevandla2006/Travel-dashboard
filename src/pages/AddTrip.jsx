...
export default function AddTrip() {
  ...
  return (
    <div className="travel-page relative min-h-screen overflow-hidden bg-[#020617] px-6 py-16 text-white">
      ...
      <div
        className="travel-backdrop pointer-events-none absolute inset-0"
        aria-hidden="true"
      >
        <div className="travel-flight-board travel-flight-board-one">
          DEPARTURES <span>08:42</span>
        </div>

        <div className="travel-flight-board travel-flight-board-two">
        ...
        <span className="travel-pin travel-pin-one">
          <FaMapMarkerAlt />
        </span>

        <span className="travel-pin travel-pin-two">
          <FaMapMarkerAlt />
        </span>
        ...
        <div className="travel-label travel-label-one">
          <span>03</span> destinations saved
        </div>

        <div className="travel-label travel-label-two">
          next stop <span>anywhere</span>
        </div>
      </div>
          ...
          <div className="travel-story space-y-8">
            ...
            <div className="space-y-6">
              ...
              <p className="max-w-2xl text-sm leading-6 text-slate-600 sm:text-base">
                Enter a place, hit generate, and watch
                your next escape take shape through a
                sharper, more cinematic lens.
              </p>
              ...
              <div className="rounded-[28px] border border-slate-800 bg-[#05070b] p-6 shadow-[0_20px_50px_rgba(15,23,42,0.22)]">
                ...
                <div className="mt-5 flex flex-wrap gap-3">
                  ...
                  {[
                    ...
                    <span
                      key={item}
                      className="travel-chip rounded-2xl border border-white/10 bg-white px-4 py-2 text-sm font-medium text-slate-900 shadow-sm"
                    >
                      {item}
                    </span>
                  ))}
            ...
            <div className="relative overflow-hidden rounded-[36px] border border-slate-800 bg-[#05070b] p-6 shadow-[0_30px_65px_rgba(0,0,0,0.25)]">
              ...
              <div className="relative z-10 grid gap-5 sm:grid-cols-3">
                ...
                {[
                  ...
                  <div
                    key={item.label}
                    className="rounded-3xl border border-white/10 bg-slate-800/80 p-4 backdrop-blur-sm"
                  >
          ...
          >
            ...
            <div className="mb-8 space-y-4">
              ...
              <p className="max-w-[22rem] text-sm leading-6 text-slate-300">
                Enter a place and we'll build a
                destination preview for you.
              </p>
            ...
            <label className="block text-center text-sm font-semibold text-slate-100">
              ...
              <input
                ...
                className="mt-4 w-full rounded-[26px] border border-white/10 bg-white px-5 py-4 font-semibold text-slate-950 outline-none transition placeholder:text-slate-500 focus:border-sky-400 focus:ring-4 focus:ring-sky-400/20"
              />
            ...
            {error && (
              <p
                className="mt-4 rounded-2xl border border-red-300/30 bg-red-500/10 px-4 py-3 text-sm text-red-200"
                role="alert"
              >
                {error}
              </p>

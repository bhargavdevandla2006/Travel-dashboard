...
export default function Navbar() {
  return (
    <div className="flex justify-between items-center">
      <h1 className="text-5xl font-bold text-gray-900">Travel Dashboard</h1>
      ...
      <div className="flex items-center gap-5">
        <div className="flex items-center gap-3 bg-white px-6 py-3 rounded-full shadow-lg hover:shadow-xl transition w-[320px] border border-gray-100">
          ...
          <input type="text" placeholder="Search destinations..." className="outline-none w-full bg-white text-gray-900 placeholder-gray-500 font-medium" />
        </div>

...
app.get("/mailbox/bookings", auth, async (req, res) => {
  try {
    const bookings = await all(`
      SELECT id, customer_name, customer_email, customer_contact,
             hotel_name, hotel_location, check_in, check_out, amount,
    ...
    console.error("GET BOOKING MAILBOX ERROR:", error);

    res.status(500).json({
      success: false,
      message: "Failed to load booking mailbox"
    });
  }
});
// ============================================================
// VERIFY RAZORPAY PAYMENT + SEND BOOKING EMAILS
// ============================================================
  ...
  async (req, res) => {
    ...
    try {
      ...
      await sendEmail({
        ...
        subject:
          "🎉 Hotel Booking Confirmed - TravelHub",
      ...
      return res.json({
        ...
        message:
          "Payment verified and hotel booking confirmed.",
      ...
      return res.status(500).json({
        ...
        message:
          "Payment verified but booking processing failed.",
    ...
    try {
        ...
        if (
            ...
            return res.status(400).json({
                success: false,
                message:
                    "Registered email is required for face login"
            });
        }
